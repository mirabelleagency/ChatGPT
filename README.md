...
A lightweight Microsoft Project–style planner implemented as a browser-based application. It supports task dependencies, automatic scheduling, critical path analysis, and an interactive Gantt chart—all without external build tooling.
...
No external dependencies are required. Static assets are organised at the repository root:
...
Feel free to customise the visuals or scheduling logic directly in these files.
